...
public class GiftsTests extends BaseUI {
    ...
    @DataProvider(name = "com.romanceabroad.ui.GiftsPage")
    ...
    /**  Test to search gifts using com.romanceabroad.ui.Data Provider and CSV file as a source*/
    ...
    public void testSearchGiftsAndVerifyOutput(){
        ...
        Assert.assertEquals(pageTitleGifts, "com.romanceabroad.ui.GiftsPage", "Actual title doesn't match with Expected title: ");
