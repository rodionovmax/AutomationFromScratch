...
public class RegistrationFormPage extends BaseActions{
...
//        wait.until(ExpectedConditions.elementToBeClickable(com.romanceabroad.ui.Locators.LOCATION_FROM_DROPDOWN));
//        driver.findElement(com.romanceabroad.ui.Locators.LOCATION_FROM_DROPDOWN).click();
        driver.findElement(Locators.CONFIRMATION_CHECKBOX).click();
//        driver.findElement(com.romanceabroad.ui.Locators.PROFILE_NEXT_BUTTON).click(); It's not working
    }
